...
export default function Leaderboard() {
  ...
  return (
    <div aria-label="Interactive element 95f1" className="min-h-screen bg-black text-white p-6 md:p-12 font-mono">
      <div data-cy="cy-855b01" className="max-w-4xl mx-auto">
        ...
        <div data-theme-role="primary-surface" className="bg-black/50 border-2 border-[#FF5500]/20 p-6 shadow-[0_0_30px_rgba(255,85,0,0.05)]">
          <div aria-label="Interactive element 3883" className="grid grid-cols-12 gap-4 text-xs text-[#FF5500]/70 mb-4 px-4 uppercase tracking-widest border-b border-[#FF5500]/20 pb-4">
            <div data-cy="cy-1adf15" className="col-span-2">Rank</div>
            <div data-theme-role="primary-surface" className="col-span-5">Hacker Alias</div>
            <div data-testid="container-58cbb6" className="col-span-2 text-center">Stage</div>
                ...
                <div data-cy="cy-f777e2" className="col-span-5 flex flex-col">
                  ...
                  <div data-testid="text-4ad9cb" className="flex items-center gap-2 mt-1">
                    {hacker.mainnet ? (
                      ...
                      <span data-component-id="a2303d75" className="text-[10px] px-1.5 py-0.5 border border-neutral-500/50 text-neutral-500 bg-neutral-500/10">UNVERIFIED</span>
                    )}
                  </div>
                </div>
