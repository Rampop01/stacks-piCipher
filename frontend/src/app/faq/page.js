...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 sm:p-6 md:p-12 font-mono selection:bg-[#FF5500] selection:text-black">
      <div className="max-w-4xl mx-auto border-l-2 border-r-2 border-[#FF5500]/30 min-h-[80vh] p-4 sm:p-8 flex flex-col relative shadow-[0_0_30px_rgba(255,85,0,0.05)]">
