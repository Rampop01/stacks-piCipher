...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 sm:p-6 md:p-12 font-mono">
      <div className="max-w-4xl mx-auto border-l-2 border-r-2 border-[#FF5500]/30 min-h-[80vh] p-4 sm:p-8 flex flex-col">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-4">
          <h1 className="text-3xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF5500] to-yellow-500 tracking-widest uppercase">{glitchTitle}</h1>
        ...
        <div className="mt-12 text-center text-xs text-neutral-600 tracking-widest">
          <p>STILL HAVE QUESTIONS? [ DISCORD_LINK_PENDING ]</p>
        </div>
      </div>
    </div>
  );
