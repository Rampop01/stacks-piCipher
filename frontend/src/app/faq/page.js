    ...
    <div className="min-h-screen bg-black text-white p-6 md:p-12 font-mono">
      <div className="max-w-4xl mx-auto border-l-2 border-r-2 border-[#FF5500]/30 min-h-[80vh] p-8">
        <div className="flex justify-between items-center mb-12">
          <h1 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF5500] to-yellow-500 tracking-widest uppercase">FAQ_DATABASE</h1>
          <Link href="/" className="px-4 py-2 border border-white/20 hover:border-white/60 text-xs transition-colors">[ RETURN ]</Link>
        </div>
