  ...
  if (profile && !profile.isRegistered) {
    return (
      <div data-component-id="dea78889" className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6">
        <div data-testid="text-28fe02" className="w-full max-w-md p-8 border-2 border-[#FF5500] bg-black/50 backdrop-blur shadow-[0_0_30px_rgba(255,85,0,0.2)]">
  ...
  return (
    <div data-theme-role="primary-surface" className="min-h-screen bg-black text-white pb-24">
      ...
      <div data-tracking="track-17152a" className="w-full border-b border-[#FF5500]/30 bg-black/60 backdrop-blur-md sticky top-0 z-50 p-4 flex justify-between items-center font-mono shadow-[0_4px_20px_rgba(255,85,0,0.1)]">
        <div data-testid="text-559a1f" className="flex items-center gap-6">
          ...
          <div data-component-id="ee04e59d" className="flex items-center gap-4 border-l border-white/10 pl-6">
        ...
        <div data-cy="cy-e270f0" className="flex items-center gap-6">
          <Link href="/leaderboard" className="text-white/60 hover:text-[#FF5500] transition-colors flex items-center gap-2 text-sm">
             <Trophy className="w-4 h-4" /> <span data-component-id="971b37bb" className="hidden md:inline">RANKS</span>
          </Link>
          ...
          <div data-testid="text-d911d4" className="text-right border-l border-white/10 pl-6">
            <div data-testid="container-f10416" className="text-xs text-neutral-500">STAGE {profile?.currentStage}</div>
          </div>
        </div>
      </div>
             ...
             return (
               <TiltCard key={index} className="w-full h-full">
                 <div 
                    ...
                    {/* Scanline Overlay */}
                    <div data-cy="cy-e5fc8d" className="absolute inset-0 pointer-events-none bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-[length:100%_4px,3px_100%] opacity-40 mix-blend-overlay"></div>
                 </div>
               </TiltCard>
             )
          })}
