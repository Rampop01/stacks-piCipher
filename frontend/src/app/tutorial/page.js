...
export default function TutorialPage() {
  ...
  return (
    <div data-theme-role="primary-surface" className="min-h-screen bg-black text-white font-mono p-6 relative overflow-hidden">
      {/* Background Grid */}
      ...
      <div data-cy="cy-4f384e" className="max-w-4xl mx-auto relative z-10">
        <Link 
          href="/" 
        ...
        <div aria-label="Interactive element 2257" className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Voice Input */}
          <div aria-label="Interactive element 24d7" className="border border-[#FF5500]/30 bg-black/50 p-6 shadow-[0_0_15px_rgba(255,85,0,0.1)] hover:border-[#FF5500] transition-colors">
